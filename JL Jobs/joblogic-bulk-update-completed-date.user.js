...
(function () {
    ...
    const SCRIPT_LABEL = '📅 Bulk Update Completed Date';
    const SCRIPT_COLOR = '#6b4226';
    const SCRIPT_DESC = 'Paste a CSV of JobID and CompletedDate; sets or updates the Completed date on each job via the API. Paste, then Start.';
