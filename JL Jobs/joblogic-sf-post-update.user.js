...
// @version      2.4
// @description  Collect latest public visit note + same-day images from Joblogic jobs, post them to matching Salesforce Support Request Chatter feed.
...
(function () {
    ...
    function makePanel(title) {
        ...
        x.textContent = 'X'; x.onclick = () => panel.remove();
        header.append(t, x);
        body.append(header);
        panel.append(body);
