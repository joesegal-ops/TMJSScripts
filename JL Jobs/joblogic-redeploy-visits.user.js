...
// @version      1.16
// @description  Scan the filtered Jobs list, navigate to each job, and redeploy eligible visits back to the same engineer so the jobs re-appear in their app.
...
<div class="body">
  ...
  <div class="log"></div>
        ...
        panelEl.querySelector('.btn-close').onclick = () => panelEl.remove();
