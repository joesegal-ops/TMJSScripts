...
(function () {
    ...
    const SCRIPT_LABEL = '🏷 Bulk Update Category';
    const SCRIPT_COLOR = '#6b4226';
    const SCRIPT_DESC = 'Paste a CSV of job number and category name; updates each job category via the API. Paste, then Start.';
