...
// @downloadURL  https://raw.githubusercontent.com/joesegal-ops/TMJSScripts/main/JL%20PPMs/joblogic-bulk-allocate-engineer.user.js
// @updateURL    https://raw.githubusercontent.com/joesegal-ops/TMJSScripts/main/JL%20PPMs/joblogic-bulk-allocate-engineer.user.js
// ==/UserScript==
...
(function () {
    ...
    const SCRIPT_ID = 'allocate-engineer';
    const SCRIPT_LABEL = '👷 Bulk Allocate Engineer';
    const SCRIPT_COLOR = '#6b4226';
    const SCRIPT_DESC = 'Paste a CSV of Job Number, Appointment Date, Engineer. Opens each job Visits tab, fills the Allocate Engineer panel and allocates, then reports existing and new visits. Paste, then Start.';
