...
// @version      2.2
// @description  For each job in the filtered Jobs list (all pages), reads PPM Visit Due Date + Duration, then sets Target Completion Date = Due Date + Duration (minutes). Supports dry run and stop.
// @author       UP-FM / Claude
...
<div class="body">
  ...
  <div id="jltd-log"></div>
        ...
        panel.querySelector('#jltd-close').onclick  = () => panel.remove();
